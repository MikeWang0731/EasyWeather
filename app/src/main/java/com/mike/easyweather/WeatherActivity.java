...
import com.mike.easyweather.gson.Forecast;
import com.mike.easyweather.gson.Weather;
import com.mike.easyweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    String weatherString = prefs.getString("weather", null);
        if (weatherString != null) {
            ...
            // Go to the server to check the weather when there is no cache
    ...
    /**
     * Process and present data in the Weather entity class
     */
    private void showWeatherInfo(Weather weather) {
        ...
        String carWash = "Car-washing：" + weather.suggestion.carWash.info;
        String sport = "Exercise advice：" + weather.suggestion.sport.info;
